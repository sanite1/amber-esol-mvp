...
export interface TutorLesson {
  ...
  cancellation?: { reason: string; cancelledBy: string };
  cancelledBy?: string;
  cancellationReason?: string;
  materials?: string[];

  // ── NEW: extra booking details for the expanded card ──
  studentLevel?: string; // alias for level (mapper sets both)
  studentCountry?: string; // alias for country
  timezone?: string;
  currency?: string;

  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4">
      ...
      <div className="relative bg-white w-full sm:max-w-2xl sm:rounded-2xl rounded-t-2xl max-h-[92vh] flex flex-col shadow-2xl">
        {/* Header */}
        <div className="sticky top-0 bg-white border-b border-[#0B2343]/[0.06] px-4 sm:px-5 py-3 sm:py-4 z-10 shrink-0">
          <div className="flex items-start justify-between gap-3">
            <div className="min-w-0 flex-1">
              <h2 className="text-sm sm:text-base font-bold text-[#0B2343] leading-snug">
                {ticket.subject}
              </h2>
        ...
        {/* Reply bar */}
        {!isClosed ? (
          <div className="sticky bottom-0 bg-white border-t border-[#0B2343]/[0.06] px-4 sm:px-5 py-3 shrink-0">
            <div className="flex items-end gap-2">
              <div className="flex-1 relative">
                <textarea
                  ...
                  rows={1}
                  className="w-full px-3 py-2.5 rounded-xl border border-[#0B2343]/[0.08] bg-[#fafbfc] text-xs sm:text-sm text-[#0B2343] placeholder:text-[#0B2343]/30 focus:outline-none focus:border-[#ff7c22]/30 transition-colors resize-none overflow-hidden"
                  style={{ maxHeight: 120 }}
                />
              </div>
              <button
          ...
          <div className="sticky bottom-0 bg-[#0B2343]/[0.02] border-t border-[#0B2343]/[0.06] px-4 sm:px-5 py-3 text-center shrink-0">

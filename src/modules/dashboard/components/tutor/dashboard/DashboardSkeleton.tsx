  ...
  return (
    <div className="bg-white rounded-2xl border border-[#0B2343]/[0.06] p-4 space-y-3">
      ...
      {Array.from({ length: 4 }).map((_, i) => (
        <div
          key={i}
          className="flex items-center gap-3 p-2.5 rounded-xl border border-[#0B2343]/[0.04]"
        >
...
export function PendingBookingsSkeleton() {
  return (
    <div className="bg-white rounded-2xl border border-[#0B2343]/[0.06] p-4 space-y-3">
      <Bone className="h-4 w-36 mb-1" />
      {Array.from({ length: 2 }).map((_, i) => (
        <div
          key={i}
          className="p-3 rounded-xl border border-[#0B2343]/[0.04] space-y-2"
        >
...
export function AvailabilitySkeleton() {
  return (
    <div className="bg-white rounded-2xl border border-[#0B2343]/[0.06] p-4">
      ...
      <Bone className="h-2.5 w-full rounded-full mb-3" />
